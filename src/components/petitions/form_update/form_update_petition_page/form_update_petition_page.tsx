...
export default function Form_update_petition_page({ slug }: Props) {
  const [isLoading, setIsLoading] = useState(false);
  const [dataUser, setDataUser] = useState<User | null>(null); // Inicializando como null até os dados serem carregados
